...
#define SWIG_init    Fract_Init
#define SWIG_name    "fract"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_myfract(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  double result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:myfract int ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "myfract" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (double)myfract(arg1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "myfract", (swig_wrapper_func) _wrap_myfract, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Fract_SafeInit(Tcl_Interp *interp) {
