...
void drawCircle(double xc,double yc,double r,string style,Gnuplot& g);
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        g1.plot_equation("sin(x)","steps");
		  ...
		  g1.set_grid();
		  string style="points";
		  //drawCircle(double xc,double yc,double r,string style="lines",Gnuplot g);
		  drawCircle(0,0,1,"lines",g1);
		  drawCircle(0,1,2,"points",g1);
...
void drawCircle(double xc,double yc,double r,string style,Gnuplot& g)
{
	...
	//cout << endl << endl << "*** user-defined lists of points (x,y)" << endl;
	//string style="points";
	g.set_style(style).plot_xy(x,y,"user-defined points 2d");
}
